...
<nav class="navbar navbar-expand-lg bg-light">
    ...
    <a class="navbar-brand <?php echo ($currentPage == '/index.php') ? 'active' : ''; ?>" href="index.php">
    <img src="upload\produit\439239939_1005289097657000_8251521961820547912_n.jpg" alt="Fatouna Beauty" style="height: 40px; margin-right: 10px; border-radius: 50%; object-fit: cover;">
    Fatouna Beauty
</a>
